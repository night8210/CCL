...
#LR_train_model(sc, data, 10, 10, "iris_LR_model")
#LR_test_model(sc, [5.1, 3.5, 1.4, 0.2], "iris_LR_model")

#DT_train_model(sc, data, {}, 10, "iris_DT_model")
#DT_test_model(sc, [5.1, 3.5, 1.4, 0.2], "iris_DT_model")

#RF_train_model(sc, data, {}, 5, 10, "iris_RF_model")
RF_test_model(sc, [5.1, 3.5, 1.4, 0.2], "iris_RF_model")

#NB_train_model(sc, data, 10, "iris_NB_model")
#NB_test_model(sc, [5.1, 3.5, 1.4, 0.2], "iris_NB_model")
